...
{{< mermaid >}}
flowchart TB
    subgraph era1990["1990s: Monolithic Era"]
        xml[XML: Everything Built-in]
        corba[CORBA: Complete RPC]
        j2ee[J2EE: Full Stack]
    end
    
    subgraph era2000["2000s: Modular Era"]
        json[JSON: Minimal Core]
        rest[REST: Compose Your Stack]
        microservices[Microservices: Service per Function]
    end
    
    subgraph era2010["2010s+: Cloud Native"]
        containers[Containers: Composable Infrastructure]
        serverless[Serverless: Atomic Functions]
        ecosystem[JSON Ecosystem: Modular Solutions]
    end
    
    era1990 -->|Backlash Against Complexity| era2000
    era2000 -->|Scale Demands Independence| era2010
    
    style era1990 fill:#4C3A3C,stroke:#6b7280,color:#f0f0f0
    style era2000 fill:#3A4C43,stroke:#6b7280,color:#f0f0f0
    style era2010 fill:#3A4A5C,stroke:#6b7280,color:#f0f0f0
{{< /mermaid >}}
