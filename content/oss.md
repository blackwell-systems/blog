...
- [gcf-proxy](https://github.com/blackwell-systems/gcf-proxy) - MCP proxy that re-encodes JSON tool responses as GCF. Drop-in, zero changes to your server. One line change in your MCP config.
- [toon-benchmark](https://github.com/blackwell-systems/toon-benchmark) - Fork of TOON's benchmark with GCF formatter added. GCF wins on their own tests.
