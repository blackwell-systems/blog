...
|---------|------|-------------|--------|
| [modelcontextprotocol/servers#4029](https://github.com/modelcontextprotocol/servers/issues/4029) | Issue | `read_media_file` returns `type: "blob"`, violating MCP spec | Fix PR [#4044](https://github.com/modelcontextprotocol/servers/pull/4044) submitted |
...
| [mark3labs/mcp-go#826](https://github.com/mark3labs/mcp-go/issues/826) | Issue | stdio transport crash on slow tools (fmt.Printf corrupts JSON-RPC) | Fix PR [#828](https://github.com/mark3labs/mcp-go/pull/828) submitted |
| [antvis/mcp-server-chart#291](https://github.com/antvis/mcp-server-chart/issues/291) | Issue | 9 tools crash with unhandled exceptions on default input | Open |
