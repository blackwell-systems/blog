...
- [goldenthread](https://github.com/blackwell-systems/goldenthread) - Build-time schema compiler (Go → TypeScript Zod)
- [gcp-secret-manager-emulator](https://github.com/blackwell-systems/gcp-secret-manager-emulator) - Production-grade GCP Secret Manager emulator (enterprise adoption)
- [vaultmux](https://github.com/blackwell-systems/vaultmux) - Unified secret management across 7+ backends
